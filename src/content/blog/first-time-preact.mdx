...
is a website development framework, similar to Astro & Nuxt (which I've talked
about on this blog before). It's more like Nuxt in that it is a single-page
application framework, meaning doesn't fully unload when you switch pages. It's
an alternative to React that is smaller but still offers the same modern APIs.
